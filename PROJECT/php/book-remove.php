...
<html lang="en">
  ...
  <body>
    ...
    <style>
      ...
      <h3 class="sub-headings-middle">Cancel booking</h3>
      <br> <br>
<center>
      <form class=class="pop-up-body"  action="../php/remove-flight.php" method="POST">
        <label>Enter Your booking number : </label>
        <input class="input" type="number" name="id" require>
