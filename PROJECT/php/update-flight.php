<?php
    ...
    $sql = "UPDATE confirmation SET class = '$class', name = '$name', NIC = '$nic', pNo = '$pNo', email = '$email' WHERE id = '$id'";
...
<html lang="en">
  ...
  <body>
    ...
    <div style="display: flex; justify-content: space-around">
      <a href="../html/Flight Details.html"><button class="select-btn">Flight Details >>></button></a>
    </div>
