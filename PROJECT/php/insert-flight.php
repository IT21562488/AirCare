...
$sql = "INSERT INTO confirmation(summary, class, name, NIC, pNo, email) VALUES ('$summary', $class, '$name', '$nic', $pNo, '$email')";

if ($conn->query ($sql)){
  echo "<script>alert('Your Confirmation Successful')</script>";
}else{
...
<html lang="en">
  ...
  <body>
    ...
    <div style="display: flex; justify-content: space-around">
      <a href="../html/go-further.html"><button class="select-btn">GO FURTHER >>></button></a>
    </div>
